...
const formatCount = (count)=>{
    ...
    if(count){
        ...
        if(!dec) return count;
            ...
            const fr = new Fraction(eval(count.toFixed(2) - int.toFixed(2)));
    ...
    const markUp =`
            ...
            <div class="recipe__ingredients">
                <ul class="recipe__ingredient-list">
                  ${recipe.ingredients.map(ingredient=>createMarkup(ingredient)).join('')}
                </ul>
...
export const updateServingsEngredients=(recipe)=>{
    //update servings
